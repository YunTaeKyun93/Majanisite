    ...
    <div>
      <div className={ss("productWrap")}>
        ...
        <div className={ss("logoWrap")}>
          <img src={ScrozaLogo} alt="logo" width="300px" />
          ...
          <Fade delay={300} right>
            <div className={ss("con1")}>
              <div className={ss("Exp1")}>
                <h2>Scorza(스코르자)</h2>
                <h4>한 입 베어무는 순간 입 안에 펼쳐지는 달콤함</h4>
                <p>
                  오늘 날에도 타의 추종을 불허하는 이탈리아에서 생산되는 가장
                  오래된 고체 형태의 초콜릿
                  <br />
                  놀라운 질감과 독특한 맛을 즐겨보세요
                </p>
              </div>
              <img src={ScorzaImg1} alt="fiatCremino" width="400px" />
            </div>
          </Fade>
          <Fade right delay={300} left>
            <div className={ss("con2")}>
              <img src={ScorzaImg2} alt="logo" width="200px" />
